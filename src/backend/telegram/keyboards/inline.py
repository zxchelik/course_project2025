...
def get_inline_kb(rows: list[list[tuple[str, str]]], prefix: str = "") -> InlineKeyboardMarkup:
    ...
    for row in rows:
        ...
        for button in row:
            if type(button) == tuple:
                text, call = button
                row_.append(InlineKeyboardButton(text=text, callback_data=prefix + call))
            else:
                row_.append(InlineKeyboardButton(text=button, callback_data=prefix + button))
        builder.row(*row_)
...
def get_confirm_user_kb(id):
    confirm_new_user = InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(text="✅Принять", callback_data=f"activate_{id}"),
...
def get_confirm_ikb(prefix: str = ""):
    ...
    confirm_kb = InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(text="✅Подтвердить", callback_data=prefix + "confirm"),
...
def get_select_number_fab():
    ...
    builder.button(text="+1", callback_data=SelectNumber(action="update_group", value=1))
    builder.button(text="-5", callback_data=SelectNumber(action="update_num", value=-5))
    ...
    builder.button(text="+5", callback_data=SelectNumber(action="update_num", value=5))
    # if is_subnum:
    builder.button(text="A", callback_data=SelectNumber(action="update_subnum", value="A"))
    builder.button(text="B", callback_data=SelectNumber(action="update_subnum", value="B"))
    builder.button(text="C", callback_data=SelectNumber(action="update_subnum", value="C"))
    builder.button(text="D", callback_data=SelectNumber(action="update_subnum", value="D"))
...
def get_select_month():
    ...
    builder.button(text="-5", callback_data=SelectMonth(action="update_month", value=-5))
    builder.button(text="-1", callback_data=SelectMonth(action="update_month", value=-1))
    builder.button(text="Месяц", callback_data=SelectMonth(action="ignore"))
    builder.button(text="+1", callback_data=SelectMonth(action="update_month", value=1))
    builder.button(text="+5", callback_data=SelectMonth(action="update_month", value=5))

    builder.button(text="-1", callback_data=SelectMonth(action="update_year", value=-1))
    builder.button(text="Год", callback_data=SelectMonth(action="ignore"))
    builder.button(text="+1", callback_data=SelectMonth(action="update_year", value=1))

    builder.button(text="Подтвердить", callback_data=SelectMonth(action="confirm"))
...
def get_select_duration_fab():
    ...
    builder.button(text="-3", callback_data=SelectDuration(action="update_hour", value=-3))
    builder.button(text="-2", callback_data=SelectDuration(action="update_hour", value=-2))
    builder.button(text="-1", callback_data=SelectDuration(action="update_hour", value=-1))
    builder.button(text="+1", callback_data=SelectDuration(action="update_hour", value=1))
    builder.button(text="+2", callback_data=SelectDuration(action="update_hour", value=2))
    builder.button(text="+3", callback_data=SelectDuration(action="update_hour", value=3))
    builder.button(text="Минуты", callback_data=SelectDuration(action="ignore"))
    builder.button(text="-15", callback_data=SelectDuration(action="update_min", value=-15))
    builder.button(text="-10", callback_data=SelectDuration(action="update_min", value=-10))
    builder.button(text="-5", callback_data=SelectDuration(action="update_min", value=-5))
    builder.button(text="+5", callback_data=SelectDuration(action="update_min", value=5))
    builder.button(text="+10", callback_data=SelectDuration(action="update_min", value=10))
    builder.button(text="+15", callback_data=SelectDuration(action="update_min", value=15))

    builder.button(text="Подтвердить", callback_data=SelectDuration(action="confirm"))
